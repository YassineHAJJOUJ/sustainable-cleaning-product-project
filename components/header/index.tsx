                ...
                <div className="mx-auto max-w-7xl pt-4 px-4 sm:px-6 lg:px-0">
                    ...
                    <Popover.Group className="hidden lg:ml-8 lg:block lg:self-stretch align-center w-full">
                        ...
                        {navigation.pages.map((page) => (
                            ...
                            key={page.name}
                            href={page.href}
                            className="flex items-center text-sm font-medium text-[#003E53] hover:text-[#003E53]/80"
                            >
                            {page.name}
                            </a>
                        ))}
                    ...
                    <div className="ml-auto flex items-center">
                        ...
                        <a href="#" className="group -m-2 flex items-center p-2">
                            ...
                            aria-hidden="true"
                            />
                            <span className="ml-2 text-sm font-medium text-[#003E53] group-hover:text-[#003E53]/80">0</span>
